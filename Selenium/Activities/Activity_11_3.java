...
//Also using findElement() to find the button to open a PROMPT alert and click it.
//Switch the focus from the main window to the Alert box.
//Using sendKeys() to type in "Yes, you are!".
//Closing the alert with alert.accept().
...
public class Activity_11_3 {
    public static void main(String[] args) throws InterruptedException {
        ...
        //Clicking the button to open a prompt
        driver.findElement(By.cssSelector("button#prompt")).click();
        //Switch to prompt window
        Alert promptAlert = driver.switchTo().alert();
        //Getting text in the prompt box and print it
